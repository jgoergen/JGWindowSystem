...
package com.wambatech.components.accordian
{
	...
	public class WTNode extends Sprite
	{
		...
		{			
			...
			_background = getChildByName("bg_mc") as MovieClip;			
			var testClipTransform:ColorTransform = new ColorTransform(0, 0, 0, 1, 220 - (level * 30), 230 - (level * 20), 255 - (level * 4), 0);
			...
			DragDropManager.registerDraggableObject(this, "string", title)
		}
